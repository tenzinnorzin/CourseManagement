...
<div class="row g-3 align-items-center">
  ...
  <div class="col-auto col-lg-8">
    <input type="text" id="inputPassord6" class="form-control" name="coursename" aria-describedby="passwordHelpInline">
  </div>
</div>
...
<div class="row g-3 align-items-center">
  ...
  <div class="col-auto col-lg-8">
    <input type="text" id="inputPassword6" class="form-control" name="courseduration" aria-describedby="passwordHelpInline">
  </div>
</div>
...
<div class="row g-3 align-items-center">
  ...
  <div class="col-auto col-lg-8">
    <input type="text" id="inputPassword6" class="form-control" name="fees" aria-describedby="passwordHelpInline">
  </div>
</div>
